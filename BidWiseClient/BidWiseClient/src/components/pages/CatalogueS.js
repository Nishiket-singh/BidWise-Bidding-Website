...
<div className="mainContainercat">  
         <div className="PhotoAndHighBidInfocat">
        <img className="forward_itemcat" alt="" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQR8dhgHvffCJbPYCmS1PoghXcmR7jKOEPMZw&usqp=CAU"></img>
</div>

<div className="ItemInfocat"> 
<h1 className="hcsscat" > Elvis Presley - Moody Blue</h1>
<div className="items">
<p><strong>Price:</strong> 49$ </p>
<p><strong>Auction Type:</strong> Dutch</p>
<p><strong>Time Left:</strong>  Now </p>             
</div>


</div>

<input className="radioo elvis" type="radio" ></input>
    
    
    </div>

   <Link exact to="/BiddingEnd">  <button className="bidbut">Bid</button></Link>
