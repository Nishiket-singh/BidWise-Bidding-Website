...
<div className="base">
    ...
    <div className="mainContainerbid">  
        ...
        <h1> Winning Price:  $599.00</h1>
        <h1>Highest Bidder: James4020</h1>
...
<p className="pcss"> <strong classname="colorblkbid">Item Description:</strong> Dive into the rich sounds of Fleetwood Mac with this authentic,
 ...
 <h1 className="hkbid"> Shipping Price: $5.00 </h1>      
 <h1 className="hkbid"> Add Expedited Shipping: $5.00 </h1> 
