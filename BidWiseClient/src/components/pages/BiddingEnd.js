...
<p className="pcss"> <strong classname="colorblkbid">Item Description:</strong> {itemInfo.itemdesc}</p>



 <h1 className="hkbid"> Shipping Price: ${itemInfo.itemshippingprice}</h1>      
 <h1 className="hkbid"> Add Expedited Shipping: ${itemInfo.expShip} </h1> 
