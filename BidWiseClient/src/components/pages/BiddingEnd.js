...
function BiddingEnd(){
    ...
    const [itemInfo, setItemInfo]=useState({
        ...
        description:"Dive into the rich sounds of Fleetwood Mac with this authentic, used copy of the iconic 'Rumours' on vinyl. Released in 1977, this album has become a cornerstone of classic rock, featuring hits that have left an indelible mark on music history.",
        shipPrice:5, 
        expShip:20,
...
<div className="base">
    ...
    <div className="mainContainerbid">  
        ...
        <h1> Winning Price:  ${itemInfo.winningPrice}</h1>
...
<p className="pcss"> <strong classname="colorblkbid">Item Description:</strong> {itemInfo.description}</p>



 <h1 className="hkbid"> Shipping Price: ${itemInfo.shipPrice}</h1>      
