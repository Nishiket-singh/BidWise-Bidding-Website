...
function ForwardAuction(){
    ...
    return (  <div className="mainContainer">  
        ...
        <h1>Highest Bidder: James4220</h1>

</div>

<div className="ItemInfo"> 
<h1 className="hcss" > Fleetwood Mac - Rumours (1st Edition)</h1>
<p className="pcss"> <strong classname="colorblk">Item Description:</strong> Dive into the rich sounds of Fleetwood Mac with this authentic,
                used copy of the iconic "Rumours" on vinyl. Released in 1977,
                this album has become a cornerstone of classic rock, featuring
                hits that have left an indelible mark on music history.</p>

<p className="pcss"><strong classname="colorblk">Condition:</strong> This vintage vinyl record is in good condition, preserving the
              warmth and authenticity of the original sound. While the cover and
              sleeve may show some signs of wear, the vinyl itself has been well
              cared for, ensuring an immersive and nostalgic listening
              experience.</p>

 <h1 className="hk"> Time Remaining: 10h:48m:34s </h1>             
