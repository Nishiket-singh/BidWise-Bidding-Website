...
<p className="pcss"> <strong classname="colorblk">Item Description:</strong>{auctionInfo.item.description} </p>

<p className="pcss"><strong classname="colorblk">Condition:</strong>{auctionInfo.item.description} </p>
