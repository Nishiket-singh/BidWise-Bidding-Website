...
function DutchAuction() {
    ...
    const [auctionInfo, setAuctionInfo]= useState({
        ...
        itemdesc: "Transport yourself back to the roots of Fleetwood Mac with this authentic, used copy of 'Then Play On' on vinyl. Originally released in 1969, this album captures the band in their early blues rock phase, showcasing their raw talent and creativity.",
  ...
  verify();
    ...
    return (<div className="mainContainerdutch">
        ...
        <div className="ItemInfodutch">
            ...
            <p className="pcss"> <strong classname="colorblkdutch">Item Description:</strong> {auctionInfo.itemdesc}</p>

            <p className="pcss"><strong classname="colorblkdutch">Condition:</strong>{auctionInfo.itemdesc} </p>
